...
//         int fileSize = getSize(in, out, fileName);
...
//                             printTransferProgress("Downloading", fileName, totalDownloaded, fileSize, spinnerIndex);
//                             spinnerIndex++;
//                         }
//                         System.out.println();
//                     }
...
//                                 printTransferProgress("Uploading", remoteFileName, totalUploaded, fileSize, spinnerIndex);
//                                 spinnerIndex++;
//                             }
//                             System.out.println();
//                         }
...
//     /**
//      * Helper to get file size, it will send SIZE command and parse the respond to get the file size in bytes.
//      * @param in
//      * @param out
//      * @param fileName
//      * @return
//      * @throws IOException
//      */
//     public static int getSize(BufferedReader in, BufferedWriter out, String fileName)throws IOException{
//         int fileSize = -1;
//         try {
//             sendCommand(out, "SIZE " + fileName);
//             fileSize = Integer.parseInt(readReply(in).trim().split("\\s+")[1]);
//         } catch (Exception e) {
//             System.out.println("[System]> Could not get file size, either because file does not exist or because something went wrong. " + e.getMessage());
//             return -1;
//         }
//         return fileSize;
//     }
...
//     /**
//      * Method to print the progress of file transfer (both upload and download). It calculates the percentage of completion based on the total size and the amount transferred, 
//      * and displays a spinner animation to indicate ongoing activity. If the total size is unknown, it will display the number of bytes transferred instead.
//      * @param action
//      * @param fileName
//      * @param transferred
//      * @param totalSize
//      * @param spinnerIndex
//      */
//     static private void printTransferProgress(String action, String fileName, long transferred, long totalSize, int spinnerIndex) {
//         String[] progressChar = {"|", "/", "-", "\\"};
//         if (totalSize > 0) {
//             int percent = (int) (transferred * 100 / totalSize);
//             System.out.print("\r[System]> " + action + " " + fileName + ": " + percent + "% " + progressChar[spinnerIndex % 4] + " (" + transferred + "/" + totalSize + " bytes)");
//         } else {
//             System.out.print("\r[System]> " + action + " " + fileName + ": " + transferred + "/" + totalSize + " bytes" + progressChar[spinnerIndex % 4]);
//         }
//     }
// }
